 ...
 */
package com.axiastudio.ooops.streams;
 ...
 * 
 */
public class OoopsInputStream extends ByteArrayInputStream implements XInputStream, XSeekable {

    public OoopsInputStream(byte[] buf) {
        super(buf);
    }
